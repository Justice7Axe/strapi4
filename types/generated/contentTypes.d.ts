...
export interface ApiAirportPickupSendingAirportPickupSending
  extends Schema.CollectionType {
  collectionName: 'airport_pickup_sendings';
  info: {
    singularName: 'airport-pickup-sending';
    pluralName: 'airport-pickup-sendings';
    displayName: 'Airport Pickup Sending';
    description: '';
  };
  options: {
  ...
  attributes: {
    startname: Attribute.String & Attribute.Required;
    endname: Attribute.String & Attribute.Required;
